...
<h1 align="center"> Chỉnh sửa tài khoản của bạn</h1>
...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="text-center"><!-- text-center Begin -->
        ...
        <button name="update" class="btn btn-secondary"><!-- btn btn-secondary Begin -->
            
            <i class="fa fa-user-md"></i> Cập nhật ngay
            
        </button><!-- btn btn-secondary inish -->
