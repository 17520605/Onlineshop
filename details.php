       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/logo.gif" alt="M-dev-Store Logo" class="hidden-xs" style="margin-top: 15px;">
                   <img src="images/logo-2.gif" alt="M-dev-Store Logo Mobile" class="visible-xs" style="margin-top: 15px;">
   ...
   <div id="content"><!-- #content Begin -->
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-12"><!-- col-md-12 Begin -->
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <?php 
                                    ...
                                    if($pro_label == "sale"){
                                        ...
                                        echo "
                                            ...
                                            Giá tiền: <del>$ $pro_price </del><br/>

                                            Giảm giá: $ $pro_sale_price 
                               ...
                               <p class="text-center buttons"><button class="btn btn-secondary i fa fa-shopping-cart"> Thêm vào giỏ hàng</button></p>
               ...
               <h3 class="text-center">Sản phẩm có thể bạn sẽ thích</h3>
                    ...
                    <div class='col-md-3 col-sm-6 center-responsive'>
                        ...
                        <div class='product'>
                            ...
                            <center>
                                ...
                                <p class='btn btn-secondary'> $manufacturer_title </p>
